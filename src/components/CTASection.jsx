const ctaData = {
  title: "Get noticed, get hired faster",
  description:
    "Build a professional resume with AuraResume and stand out with confidence. Your dream job starts with a powerful first impression.",
  buttonText: "Land Your Dream Job"
};
